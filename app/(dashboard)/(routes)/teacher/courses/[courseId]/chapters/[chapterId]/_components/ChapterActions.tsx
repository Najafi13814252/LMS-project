...
function ChapterActions({ disabled, chapterId, courseId, isPublished }: ChapterActionsProps) {
    ...
    return (
        <div className="flex items-center gap-x-2">
            <Button onClick={onPublish} disabled={disabled || isPending} size="sm" variant="outline">
                {isPublished ? "عدم انتشار" : "انتشار فصل"}
            </Button>
            <ConfirmModal onConfirm={onDelete} disabled={isPending} source="فصل">
                <Button size="sm">
